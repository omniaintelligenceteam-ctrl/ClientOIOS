...
export function ChatPanel({ onClose }: ChatPanelProps) {
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50 flex h-[500px] w-[400px] flex-col overflow-hidden rounded-2xl border border-[rgba(148,163,184,0.15)] bg-white/[0.03] shadow-2xl shadow-black/40 animate-chat-slide-up sm:right-6">
      {/* Header */}
